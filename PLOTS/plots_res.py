...
def main(filepath, var_name, fig_name, infos, freq):
    ...
    # plot
    plotpath = fig_name + '_C1D_PAPA32_' + freq + '.png'
...
if __name__=="__main__":
    ...
    main( filepath='C1D_PAPA32_1d_20100615_20110614_grid_T.nc' , var_name='votemper' , fig_name='T' , infos=infos , freq='1d' )

    # salinity
    infos = [ 'S (psu)' , cmocean.cm.haline , colors.Normalize(vmin=32, vmax=34), lambda x: x ]
    main( filepath='C1D_PAPA32_1d_20100615_20110614_grid_T.nc' , var_name='vosaline' , fig_name='S' , infos=infos , freq='1d' )

    # U
    infos = [ 'Velocity U (m/s)' , cmocean.cm.balance , colors.Normalize(vmin=-0.15, vmax=0.15), lambda x: x ]
    main( filepath='C1D_PAPA32_1d_20100615_20110614_grid_U.nc' , var_name='uo' , fig_name='u' , infos=infos , freq='1d' )

    # V
    infos = [ 'Velocity V (m/s)' , cmocean.cm.balance , colors.Normalize(vmin=-0.15, vmax=0.15), lambda x: x ]
    main( filepath='C1D_PAPA32_1d_20100615_20110614_grid_V.nc' , var_name='vo' , fig_name='v' , infos=infos , freq='1d' )
